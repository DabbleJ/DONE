...
export type Member = { id: string; userId?: string; name: string; initial: string; color: string; pronouns?: Pronouns; avatar?: string; personalityHints?: string; managed?: boolean; role?: HouseholdRole };
